...
import { fetchCustomers, fetchStaffs } from 'src/redux/actions/staff_actions';
...
export default function Customer() {
  ...
  const staffs = useSelector((state) => state.staff.customers);
  ...
  const isLoading = useSelector((state) => state.staff.customerLoading);
  ...
  return (
    <Page title="Customers">
      <Container>
        {
          staffLoading || roleAndPermissionLoading || isLoading?
            <Loading />
            :
            <>
              {
                              ...
                              {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                                ...
                                return (
                                  ...
                                  >
                                    ...
                                    <TableCell align="left">User/Customer</TableCell>
                                    <TableCell align="center">
                                     {
...

                                      {
                                        ...
                                        ""
                                        //   <UserEditDialog userName="User" userRoles={roleAndPermissions} userId={id}/>
                                          :
                                          ""
                                      }
                                      </Box>
